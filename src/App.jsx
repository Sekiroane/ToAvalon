...
const GOLD  = "#c8a050";
const GOLD2 = "#8b6520";
// Tip address defined in TipModal below
...
const TIP_QR   = "data:image/png;base64,";
const TIP_ADDR = "0x280F5044b7621d2Cfd68103f4657e96882C20647";

function TipModal({onClose}) {
  const [copied, setCopied] = useState(false);
  const copy = () => {
    try { navigator.clipboard.writeText(TIP_ADDR); } catch {}
    setCopied(true); setTimeout(()=>setCopied(false), 2000);
  };
  return (
    <div style={{position:"fixed",inset:0,zIndex:700,display:"flex",alignItems:"center",justifyContent:"center",padding:24}}>
      <div style={{position:"absolute",inset:0,background:"rgba(0,0,0,.75)",backdropFilter:"blur(14px)"}} onClick={onClose}/>
      <div style={{position:"relative",width:"100%",maxWidth:340,zIndex:1,animation:"modalIn .25s ease both"}}>
        ...
        <div style={{background:"rgba(18,16,14,.98)",border:"1px solid rgba(200,160,80,.2)",borderRadius:20,padding:"28px 24px 24px",display:"flex",flexDirection:"column",alignItems:"center",gap:18}}>
          <div style={{textAlign:"center"}}>
            <div style={{fontSize:22,marginBottom:6}}>🍎</div>
            <div style={{fontSize:18,fontWeight:700,color:"#f0ece4",letterSpacing:"-.02em"}}>Leave a tip</div>
            <div style={{fontSize:13,color:"#6b6050",marginTop:4,lineHeight:1.5}}>If ToAvalon has been useful,<br/>send a little ETH to keep the isle alive.</div>
          </div>
          {/* QR Code */}
          <div style={{background:"#120e0a",border:"1px solid rgba(200,160,80,.15)",borderRadius:14,padding:14}}>
            <img src={TIP_QR} alt="ETH Tip QR" width={200} height={200} style={{display:"block",borderRadius:6}}/>
          </div>
          <div style={{fontSize:11,color:"#5a5040",textAlign:"center"}}>Scan with your phone camera · ETH only</div>
          {/* Address row */}
          <div style={{width:"100%",background:"rgba(200,160,80,.06)",border:"1px solid rgba(200,160,80,.12)",borderRadius:10,padding:"10px 14px",display:"flex",alignItems:"center",gap:8}}>
            <span style={{fontSize:10,color:"#6b6050",fontFamily:"monospace",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",flex:1}}>0x280F5044b7621d2Cfd68103f4657e96882C20647</span>
            <div onClick={copy}
              style={{fontSize:11,color:copied?"#30d158":GOLD,cursor:"pointer",flexShrink:0,userSelect:"none",transition:"color .2s"}}
